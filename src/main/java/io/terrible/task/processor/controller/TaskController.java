...
/**
 * These are quick endpoints for development, they will be replaced with something else at some point...
 *
...
public class TaskController {
     ...
     */
    @PostMapping("/task/thumbnails")
    public Mono<Boolean> thumbnails(@RequestBody final MediaFile mediaFile) {

        final boolean messageSent = workerService.createThumbnail(mediaFile.getPath(), mediaFile.getThumbnailPath());
